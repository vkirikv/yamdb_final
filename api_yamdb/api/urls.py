...
from .views import APISignup, auth_token, CategoryViewSet, CommentViewSet
from .views import GenreViewSet, ReviewViewSet, TitleViewSet
from .views import user_detail, user_list, user_me
